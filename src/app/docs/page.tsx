        ...
        <MinecraftContainer>
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex justify-center mb-4">
                    <Link href="/">
                        <MinecraftButton className="text-minecraft-xs">
                            ← Back to Home
                        </MinecraftButton>
                    </Link>
                </div>
                ...
                {activeSection === 'tests' && (
                    <div className="space-y-6">
                        <MinecraftCard>
                            <h2 className="text-minecraft-lg font-minecraft text-white mb-6">🧪 API Test</h2>
                            <p className="text-minecraft-md text-gray-200 mb-6 leading-relaxed">
                                Test all API endpoints to verify functionality and performance.
                            </p>
